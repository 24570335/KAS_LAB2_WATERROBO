function BrushBot_GUI(Bot)
    ...
    % Set the base transformation matrix at origin
    brushBot.model.base = transl(0, 0, 0);  

    % Create a new figure and axes for robot visualization
    ...
    % Joint configuration controls label
