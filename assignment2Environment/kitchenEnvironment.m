classdef kitchenEnvironment < handle
    ...
    methods(Static)
        function EnvironmentSafety()
            ...
            bottle_body = PlaceObject('BottleBody.ply');  % Place on top of table (adjust coordinates as needed
            ...
            bottle_cap = PlaceObject('BottleCap.ply');  % Place on top of table, on top of BOTTLE BODY (adjust coordinates as needed
